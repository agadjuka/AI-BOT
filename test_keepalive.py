...
def main():
    ...
    if service_url:
        ...
        # Пробуем использовать известный URL Cloud Run
        cloud_run_url = "https://ai-bot-366461711404.asia-southeast1.run.app"
        print(f"\n🧪 Пробуем использовать известный URL Cloud Run: {cloud_run_url}")
        asyncio.run(test_keep_alive_ping(cloud_run_url, test_duration=30))
