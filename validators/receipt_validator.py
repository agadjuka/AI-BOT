...
class ReceiptValidator:
    ...
    def validate_receipt_data(data: ReceiptData, context: Optional[Any] = None) -> Tuple[bool, str]:
        ...
        if not items:
            return False, get_global_locale_manager().get_text("validation.no_items", context)
        ...
        if line_numbers != expected_numbers:
            return False, get_global_locale_manager().get_text(
        ...
        for item in items:
            ...
            if quantity is not None and price is not None and total is not None and quantity > 0 and price > 0 and total > 0:
                ...
                if abs(expected_total - total) > 0.01:
                    warning_msg = get_global_locale_manager().get_text(
        ...
        return True, get_global_locale_manager().get_text("validation.data_correct", context)
    ...
    def validate_line_number(data: ReceiptData, line_number: int, context: Optional[Any] = None) -> Tuple[bool, str]:
        ...
        if line_number < 1:
            return False, get_global_locale_manager().get_text("validation.line_number_too_small", context)
        ...
        return True, get_global_locale_manager().get_text("validation.line_number_correct", context)
    ...
    def validate_numeric_input(value: str, field_name: str, context: Optional[Any] = None) -> Tuple[bool, str, float]:
        ...
        try:
            ...
            return True, get_global_locale_manager().get_text("validation.value_correct", context), numeric_value
        except ValueError:
            return False, get_global_locale_manager().get_text(
    ...
    def validate_text_input(value: str, field_name: str, context: Optional[Any] = None) -> Tuple[bool, str]:
        ...
        return True, get_global_locale_manager().get_text("validation.value_correct", context)
