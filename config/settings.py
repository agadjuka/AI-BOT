...
- Переводи только наименование товара, без количества, веса и других характеристик
- Пример: "свежий томат 1кг" → "Fresh Tomato"
- Пример: "TIMUN" → "Cucumber"
- Пример: "WORTEL" → "Carrot"
- Пример: "TOMAT" → "Tomato"
...
*   **СЦЕНАРИЙ 1: СТРОКА С ЦИФРАМИ.** (Есть хотя бы одно число: кол-во, цена или сумма)
    - name: Текст товара, переведенный на английский если нужно. Если нечитаем -> "???".
