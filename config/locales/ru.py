...
RU_TRANSLATIONS = {
    ...
    "welcome": {
        ...
        "start_instruction": "Добро пожаловать в бота для сканирования чеков! 👋\n\nЯ помогу вам автоматически переносить данные из чеков прямо в вашу Google Таблицу, экономя ваше время.\n\n**Чтобы начать, выполните три простых шага:**\n\n📊 **1. Подключите Google Таблицу**\nЭто место, куда будут сохраняться все данные. Зайдите в **Личный кабинет**, чтобы добавить ссылку на вашу таблицу и выдать боту доступ.\n\n📝 **2. Загрузите список ингредиентов**\nЭто ваш личный справочник товаров. Когда я отсканирую в чеке «Kетчуп томатный Heinz Spicy», я найду в вашем списке «Tomato sause» и запишу в таблицу именно это название. Так ваши данные всегда будут чистыми и одинаковыми.\n\n📸 **3. Сканируйте чеки!**\nКогда всё настроено, просто отправьте мне фото чека, и я сделаю всю работу.",
        "instruction": "📖 *Инструкция по использованию бота*\n\n*Основные функции*\n\n🔹 Сканирование чеков - отправьте фото чека, и бот автоматически извлечет все товары и цены\n🔹 Сопоставление ингредиентов - бот найдет товары из чека в вашем списке ингредиентов для единообразного названия\n🔹 Загрузка в Google Таблицы - все данные автоматически сохраняются в вашу таблицу\n\n*Как начать работу*\n\n1️⃣ Настройте Google Таблицу в личном кабинете\n2️⃣ Загрузите список ингредиентов для правильного сопоставления товаров\n3️⃣ Отправьте фото чека для анализа\n\n*Дополнительные возможности*\n\n✏️ Редактирование - можете исправить любые данные перед загрузкой\n🔄 Повторный анализ - если что-то пошло не так\n📊 Предварительный просмотр - посмотрите данные перед сохранением\n\n*🚀 Режим TURBO*\n\n⚡ Включен - максимальная скорость обработки фото\n⏹️ Выключен - максимальное качество сканирования\n\n*📱 Мобильный и компьютерный вид*\n\n📱 Смартфон - компактные таблицы для маленьких экранов\n🖥️ Компьютер - полные таблицы для больших экранов\n\n*Команды*\n• /start - главное меню\n• /dashboard - личный кабинет",
        "analyze_receipt": "📸 Анализ чека\n\nОтправьте фото чека для анализа:",
        "main_menu": "🏠 Главное меню\n\nИспользуйте /start для начала новой работы.",
        "choose_language": "🌍 Выберите язык / Choose language:",
        "new_receipt_ready": "🎉 **Готов к обработке нового чека!**\n\n📸 Отправьте изображение квитанции в чат, и я проанализирую его для вас.\n\n✨ Бот готов к работе!",
        "dashboard": {
    ...
    "buttons": {
        ...
        "personal_dashboard": "⚙️ Личный кабинет",
    ...
    "add_sheet": {
        ...
        "step3_sheet_info": "Данные будут записываться в лист: <code>Sheet1</code>",
        ...
        "mapping_editor": {
            ...
            "sheet_info": "Лист: <code>{sheet_name}</code>",
            ...
            "sheet_name_input": "Укажите **новое название листа** (например, `Sales Data`). Название должно точно соответствовать имени листа в вашей Google Таблице.",
            "errors": {
    ...
    "sheets": {
        ...
        "callback": {
            ...
            "matching_table_title": "**Сопоставление с Google Таблицами:**",
            ...
            "back_to_receipt": "◀️ Вернуться к чеку",
            "upload_to_google_sheets": "✅ Загрузить в Google Таблицы",
            "upload_to_sheet": "📊 Загрузить в '{sheet_name}'",
            "upload_to_main_sheet": "✅ Загрузить в '{sheet_name}'",
            "back": "◀️ Назад",
            ...
            "sheet_name_label": "**Лист:** `{sheet_name}`"
        }
    },
    ...
    # Контроль доступа
    "access_control": {
        "access_denied": "Извините, у вас нет доступа к этому боту. Пожалуйста, свяжитесь с администратором @markov1u",
        "admin_only": "Эта команда доступна только администратору."
    },
    
    # TURBO режим
    "turbo_mode": {
        "enabled_simple": "🚀 Режим TURBO включен\n\n_Обработка файлов на максимальной скорости\\._\n_Качество сканирования может быть снижено\\._\n_Не рекомендуется для рукописных квитанций\\._",
        "disabled_simple": "⏹️ Режим TURBO выключен\n\n_Максимальное качество сканирования квитанций\\._",
        "enabled": "🚀 Режим TURBO включен\n\nТеперь все обработки фото будут отправляться напрямую в Gemini Flash без обработки в OpenCV для максимальной скорости!\n\n🔍 **OpenCV анализ отключен**",
        "disabled": "🚀 Режим TURBO выключен\n\nВернулись к стандартной обработке с использованием OpenCV.\n\n🔍 **OpenCV анализ включен**",
        "status_enabled": "✅ TURBO режим включен (OpenCV отключен)",
        "status_disabled": "❌ TURBO режим выключен (OpenCV включен)",
        "description": "🚀 **TURBO режим**\n\nВ этом режиме фото отправляются напрямую в Gemini Flash без предварительной обработки в OpenCV.\n\n**Преимущества:**\n• ⚡ Максимальная скорость обработки\n• 🎯 Прямая работа с AI\n\n**Недостатки:**\n• 📷 Меньше оптимизации изображения\n• 🔍 Может быть менее точным для плохих фото\n\n**Обратная зависимость:**\n• TURBO включен → OpenCV отключен\n• TURBO выключен → OpenCV включен\n\n**Текущий статус:** {status}",
        "buttons": {
            "toggle_turbo": "🚀 Переключить TURBO",
            "back_to_dashboard": "⬅️ Назад в кабинет"
        }
    },
    
    # Уведомления о переключении режимов отображения
    "display_mode_notifications": {
        "mobile_selected": "📱 Выбран интерфейс для смартфона",
        "desktop_selected": "🖥️ Выбран интерфейс для компьютера",
        "error_switching": "❌ Ошибка при переключении режима"
    },
    
    # Кнопки устройств
    "device_buttons": {
        "smartphone": "📱 Смартфон ✔️",
        "computer": "🖥️ Компьютер ✔️"
    },
