...
EN_TRANSLATIONS = {
    ...
    "ingredients": {
        "management": {
            ...
            "file_upload_request": "Please send me a text file (.txt) with your ingredients list. Each ingredient should be on a new line.",
            "text_upload_request": "📝 Upload List from Text\n\nSend your ingredients list as a text message where each ingredient is written on a new line.\n\nExample:\nMilk\nBread\nEggs\nButter",
            "text_upload_success": "✅ List of {count} ingredients successfully loaded from text!",
            "text_upload_error_empty": "Message is empty or contains no valid ingredients.",
            "text_upload_error_processing": "Error processing text. Please try again.",
            "file_upload_success": "✅ List of {count} ingredients successfully loaded!",
            "file_upload_error_format": "Please send a file in .txt format.",
            "file_upload_error_empty": "The file is empty or contains no valid ingredients.",
            "file_upload_error_processing": "Error processing the file. Please try again.",
            "delete_confirmation": "⚠️ **Delete Ingredients List**\n\nAre you sure you want to delete your current ingredients list? This action cannot be undone.",
            "delete_success": "✅ Ingredients list successfully deleted!",
            "delete_error": "❌ Error deleting ingredients list. Please try again.",
            "buttons": {
    ...
    "sheets": {
        ...
        "callback": {
            ...
            "no_sheet_configured": "❌ No Google Sheet configured\n\nPlease configure a Google Sheet in bot settings first.",
            "service_not_available": "❌ Google Sheets service unavailable\n\nCheck connection settings.",
            "quota_exceeded": "⚠️ Google Sheets API quota exceeded\n\nPlease try uploading data later. The system will automatically retry.",
            "permission_denied": "❌ No access to Google Sheet\n\nCheck service account permissions.",
            ...
            "no_sheets_found": "❌ You don't have any connected sheets",
            "no_sheet_selected": "❌ No sheet selected",
            "sheet_not_found": "❌ Sheet not found",
            "switching_sheet": "🔄 Switching sheet...",
            "date_header": "Date",
            "volume_header": "Vol",
            "price_header": "price",
