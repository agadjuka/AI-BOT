"""
Версия с Google AI для тестирования
"""
import os
...
# FastAPI app
app = FastAPI(title="AI Bot Google AI", description="Telegram Bot with Google AI for testing")
...
async def start_command(update, context):
    ...
    await update.message.reply_text("Hello! Bot with Google AI is working!")
...
async def initialize_bot():
    ...
    print("🚀 Инициализация Telegram бота с Google AI...")
    ...
    print("🚀 Telegram бот с Google AI инициализирован")
...
async def health_check():
    ...
    return {"status": "ok", "message": "AI Bot Google AI is running"}
...
if __name__ == "__main__":
    ...
    print(f"Starting Google AI bot server on port {port}")
